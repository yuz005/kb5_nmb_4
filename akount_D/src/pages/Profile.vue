    ...
    <div class="row justify-content-center">
      <div class="col-md-8 col-lg-6">
        ...
        <form>
          <div class="mb-4 d-flex align-items-center justify-content-center">
            <div class="d-flex align-items-center">
              ...
              <div>
                ...
                <div>@ {{ profileStore.profile.account_id }}</div>
              </div>
            </div>
          </div>
          <div class="mt-3 mb-3">
          ...
          <div class="mt-3 mb-3">
            <label for="phone_number" class="form-label fw-bold">전화번호</label>
            <input type="text" class="form-control" :placeholder="profileStore.profile.phone_number" v-model="phone_number">
          </div>
          <div class="d-flex justify-content-end">
            <button type="button" class="btn btn-success mt-3" @click="saveChanges">변경 사항 저장</button>
          </div>
        </form>
      </div>
    </div>
